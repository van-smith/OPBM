...
img.grayscale();
	...
	public void populate(Xml results)
	{
		...
		for (i = 0; i < list.size(); i++)
		{
			...
			line = new ResultsViewerLine(this, m_pan, m_lblBottom, m_imgBackground, m_lblGraphInternal, m_imgGraphInternal, m_imgGraphInternalMask, 1, true, false, false, item);
											   ...
											   ResultsViewerLine	parent)
	{
		...
		for (i = 0; i < list.size(); i++)
		{
			...
			// Create the entry for this level
			line = new ResultsViewerLine(this, m_pan, m_lblBottom, m_imgBackground, m_lblGraphInternal, m_imgGraphInternal, m_imgGraphInternalMask, 2, false, false, false, item);
											   ...
											   ResultsViewerLine	parent)
	{
		...
		for (i = 0; i < list.size(); i++)
		{
			...
			// Create the entry for this level
			line = new ResultsViewerLine(this, m_pan, m_lblBottom, m_imgBackground, m_lblGraphInternal, m_imgGraphInternal, m_imgGraphInternalMask, 3, false, false, false, item);
...
//		m_imgBackground = new AlphaImage(Opbm.locateFile("results_viewer_background6.png"));		// Z80 CPU die
	...
	private void extractGraph()
	{
		...
		m_lblGraphInternal.setBounds(190, 77, 580, 155);
