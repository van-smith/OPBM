...
public class BenchmarksMolecule
{
	public BenchmarksMolecule(BenchmarksParams bp)
	{
...
// FLOW
		if (thisCommand.getName().equalsIgnoreCase("flow")) {
			...
			return(m_bp.m_bpAtom.processFlow_Atom(thisCommand, molecule, xmlRunAppendTo));
...
// ABSTRACT
			...
			return(m_bp.m_bpAtom.processAbstract_Atom(thisCommand, molecule, xmlRunAppendTo));
...
// ATOM
			...
			// It's an atom
			return(processMolecule_Atom(thisCommand, molecule, xmlRunAppendTo));
	 ...
	 * @return
	 */
	public Xml processMolecule_Atom(Xml		thisCommand,
									Xml		molecule,
									Xml		xmlRunAppendTo)
	{
		return(null);
