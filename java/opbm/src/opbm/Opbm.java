 ...
 * @author Rick C. Hodgin
 */
public class Opbm implements	AdjustmentListener,
								KeyListener,
								MouseWheelListener,
								ComponentListener
{
    ...
    public Opbm(String[] args)
	{
		...
		// REMEMBER I desire to change this later to use fonts.xml file
    ...
    public void createAndShowGUI()
	{
		...
		frame.setTitle("OPBM - Office Productivity Benchmark");
...
//		m_opbm.createAndShowResultsViewer("results.xml");
    }
