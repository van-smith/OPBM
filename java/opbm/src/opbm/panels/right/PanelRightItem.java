							   ...
							   FocusListener
{
	 ...
	 */
	public PanelRightItem(Opbm			opbm,
						  Macros		macroMaster,
	...
	public static final int _TYPE_LABEL			= 1;
	public static final int _TYPE_BUTTON		= 2;
	public static final int _TYPE_CHECKBOX		= 3;
	public static final int _TYPE_TEXTBOX		= 4;
	public static final int _TYPE_EDITBOX		= 5;
	public static final int _TYPE_LISTBOX		= 6;
