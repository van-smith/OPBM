/**
 * This class stores two items, associating each with the other.  Duplicates
 * are allowed.
 *
 *	First	- String, text id associated with
 *	Second	- Object, which must be cast to its original ... whatever it was
 *
 *
 */
