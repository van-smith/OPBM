...
; Begin at 2, refer to wordCommon to see 0 and 1
$gBaselines[2][0] = $CLOSE_EMPTY_DOCUMENT
$gBaselines[2][1] = 1.6410933948
$gBaselines[3][0] = $OPEN_ALICE_IN_WONDERLAND
$gBaselines[3][1] = 7.6631180107
$gBaselines[4][0] = $TIME_TO_PAGE_DOWN_N_TIMES
$gBaselines[4][1] = 7.639845936
$gBaselines[5][0] = $SAVE_AS_PDF
$gBaselines[5][1] = 5.1305792355
